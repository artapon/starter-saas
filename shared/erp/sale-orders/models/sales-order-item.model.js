...
const SalesOrderItem = sequelize.define('SalesOrderItem', {
  ...
  discountType:   { type: DataTypes.STRING,         allowNull: false, defaultValue: 'percent', comment: "Line Discount Type ('percent' | 'fixed') (ชนิดส่วนลดบรรทัด)" },
  discountValue:  { type: DataTypes.DECIMAL(10, 2), allowNull: false, defaultValue: 0, comment: 'Line Discount (% or amount) (ส่วนลดบรรทัด)' },
